...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/gov/uk/check/visa/demo/screenshots/";
    ...
    public void selectProduct(List<WebElement> element, String nameProduct) {
        List<WebElement> listOfElements =  element;
        for (WebElement element1 : listOfElements) {
            if (element1.getText().equalsIgnoreCase(nameProduct)) {
                element1.click();
            }
        }
    }
